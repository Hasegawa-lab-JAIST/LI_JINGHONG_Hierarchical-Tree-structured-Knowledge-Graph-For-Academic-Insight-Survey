...
# Add discription
d_text='Relevance-tree - For Longitudinal insight survey'
d_d='Issue ontology selected in the fishbone diagram'
d_text1='Papers with high relevance to the issue ontology selected in the fishbone diagram.'
d_text2='What issues does this paper resolved, e.g : things achieved in this paper.'
d_text3='What issues does this paper mentioned that need to be solved, e.g : future and limitation of this paper.'
d_text4="Keywords that reflect this paper's characteristics compared to other papers in the tree"
d_text5='Attempt to gain a comprehensive understanding of the relationships between papers by analyzing summaries of the issue ontology and co-occurring words.'

description = f"""
    <div style="font-family: Arial, sans-serif; margin: 20px; padding: 10px; background-color: #f9f9f9; border: 1px solid #ddd;">
        <h2>{d_text}</h2>
        <p>Expression : Node represent the titles of papers, edge represent the co-occurance words between papers.</p>
        <ul>
            <li><b>Eclipse (On the top)</b>: {d_d}</li>
            <li><b>Root node</b>: {d_text1}</li>
            <li><b>Resolved issue</b>: {d_text2} </li>
            <li><b>Finding issue</b>: {d_text3}</li>
            <li><b>Keyword</b>: {d_text4}</li>
            <li><b>Mission</b>: {d_text5}</li>
        </ul>
    </div>
"""

# Open the generated HTML file and insert the description
with open('Relevance_tree.html', 'r', encoding='utf-8') as file:
    html_content = file.read()

# Insert the description before the network's container div
if "<h2>Network Overview</h2>" not in html_content:
    # Insert the description before the network's container div
...
with open('Relevance_tree.html', 'w', encoding='utf-8') as file:
    file.write(custom_html_content)
